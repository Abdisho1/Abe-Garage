...
function Home() {
  return (
    ...
    <section class="video-section">
        <div data-parallax='{"y": 50}' class="sec-bg" style={banner1}>
        </div>
        <div class="auto-container">
            ...
            <div class="video-box">
                <div class="video-btn"><a href="https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s"
                        class="overlay-link lightbox-image video-fancybox ripple"><i class="flaticon-play"></i></a></div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="image-box">
                        <img src={vban1} alt=""/>
                        <img src={vban2} alt=""/>
                        <div class="year-experience" data-parallax='{"y": 30}'><strong>23</strong> years <br/> Experience </div>
                    </div>
                </div>
    ...
    <section class="features-section">
        <div class="auto-container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image"><img src={image3} alt=""/></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="video-section">
        <div data-parallax='{"y": 50}' class="sec-bg" style={bg1}></div>
        <div class="auto-container">
